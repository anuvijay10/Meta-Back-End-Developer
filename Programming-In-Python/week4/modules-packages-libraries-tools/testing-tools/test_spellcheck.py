...
def test_length(input_value):
    ...
    assert s.word_count(input_value) < 10

    assert s.char_count(input_value) < 50
...
def test_struc(input_value):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    assert s.first_char(input_value).isupper()
    assert s.last_char(input_value) == "."
    # raise NotImplementedError()
